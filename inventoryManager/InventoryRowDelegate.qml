...
ItemDelegate {
    ...
    readonly property bool isNarrow: ApplicationWindow.window
                                     ...
                                     : false
    readonly property int indentWidth: Math.min(modelData.depth * 16, 80)
    readonly property string qtyText: qsTr("×%1").arg(modelData.quantity)
    readonly property string weightText: {
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            ...
            Item {
                Layout.preferredWidth: root.indentWidth
                ...
                Label {
                    ...
                    visible: modelData.depth > 5
                    text: qsTr("L%1").arg(modelData.depth)
                    opacity: 0.5
                    font.pixelSize: 11
                }
            }
